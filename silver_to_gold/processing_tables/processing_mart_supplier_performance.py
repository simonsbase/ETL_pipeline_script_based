...
output_dir = 's3://gold/marts/mart_supplier_performance/ingestion_20_05_2026/mart_supplier_performance.parquet'

connection = run_sql_job(sql_mart_supplier_performance_dir)
